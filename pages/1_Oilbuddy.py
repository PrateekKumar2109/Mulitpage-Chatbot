...
qa=ChatVectorDBChain.from_llm(llm=Cohere(model="summarize-xlarge", cohere_api_key="vGCEakgncpouo9Nz0rsJ0Bq7XRvwNgTCZMKSohlg",temperature=0.88,max_tokens= 400),
                              qa_prompt=QA_PROMPT,k=6,vectorstore=docsearch
                              #,return_source_documents=False,verbose=True,streaming=True
